...
-- Dumping database structure for db_presensi_penggajian
DROP DATABASE IF EXISTS `db_presensi_penggajian`;
CREATE DATABASE IF NOT EXISTS `db_presensi_penggajian` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `db_presensi_penggajian`;

-- Dumping structure for table db_presensi_penggajian.bagian
...
-- Dumping data for table db_presensi_penggajian.bagian: ~3 rows (approximately)
DELETE FROM `bagian`;
...
-- Dumping structure for table db_presensi_penggajian.bagian_karyawan
...
-- Dumping data for table db_presensi_penggajian.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping structure for table db_presensi_penggajian.jabatan
...
-- Dumping data for table db_presensi_penggajian.jabatan: ~5 rows (approximately)
DELETE FROM `jabatan`;
...
-- Dumping structure for table db_presensi_penggajian.jabatan_karyawan
...
-- Dumping data for table db_presensi_penggajian.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping structure for table db_presensi_penggajian.karyawan
...
-- Dumping data for table db_presensi_penggajian.karyawan: ~8 rows (approximately)
...
-- Dumping structure for table db_presensi_penggajian.lokasi
...
-- Dumping data for table db_presensi_penggajian.lokasi: ~3 rows (approximately)
DELETE FROM `lokasi`;
...
-- Dumping structure for table db_presensi_penggajian.penggajian
...
-- Dumping data for table db_presensi_penggajian.penggajian: ~18 rows (approximately)
...
-- Dumping structure for table db_presensi_penggajian.pengguna
...
-- Dumping data for table db_presensi_penggajian.pengguna: ~8 rows (approximately)
...
-- Dumping structure for table db_presensi_penggajian.presensi
...
-- Dumping data for table db_presensi_penggajian.presensi: ~552 rows (approximately)
